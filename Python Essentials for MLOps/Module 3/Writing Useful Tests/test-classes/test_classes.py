...
class TestStrToInt:
    ...
    def setup(self): # this is a setup method that will run once before each test
        print('\nthis is setup')

    def teardown(self): # this is a teardown method that will run 
        print('\nthis is teardown')
    ...
    def test_rounds_down(self):
        ...
        assert result == 2 # change from 2 to 1 to make test pass
